...
class SentimentCollector:
    ...
    def _fetch_truth_social_rss() -> List[Dict[str, Any]]:
        ...
        For now, raises ValueError to trigger graceful degradation
        unless overridden with mocking in tests.
        """
        raise ValueError(
            "Truth Social RSS fetch is stubbed. "
            "Override with mock in tests, or configure for live use."
        )
    ...
    def _fetch_capitol_trades_html() -> List[Dict[str, Any]]:
        ...
        """
        raise ValueError(
            "Capitol Trades HTML fetch is stubbed. "
            "Override with mock in tests, or configure for live use."
        )
