...
ASSET_UNIVERSE: dict[str, Asset] = {
    ...
    "VXX": Asset("VXX", "iPath S&P 500 VIX Short-Term Futures ETN", "etf", None, {"vol": 1.0, "beta": -0.5}),
    "UVXY": Asset("UVXY", "ProShares Ultra VIX Short-Term Futures", "etf", None, {"vol": 1.5, "beta": -0.8}),
    ...
    "XLI": Asset("XLI", "Industrial Select Sector SPDR", "etf", "Industrials", {"beta": 1.0}),
    "VNQ": Asset("VNQ", "Vanguard Real Estate ETF", "etf", "Real Estate", {"rate": -0.4, "beta": 0.7}),
    "UUP": Asset("UUP", "Invesco DB US Dollar Index Bullish", "etf", "FX", {"dollar": 1.0, "beta": -0.1}),
    "FXE": Asset("FXE", "Invesco CurrencyShares Euro Trust", "etf", "FX", {"euro": 1.0, "beta": 0.1}),
