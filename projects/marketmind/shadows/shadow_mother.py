...
class ShadowMother:
    ...
    async def orchestrate_daily_cycle(self, news_items: list[dict],
        ...
        performances = await self._orchestrator.step_rank_and_calibrate(visible, today, result, market_data)
        await self._orchestrator.step_surveillance(all_votes, market_data, today, result, visible)
        ...
        await self._step_maintenance(visible, result)
