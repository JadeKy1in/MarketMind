...
def test_index_and_search():
    with tempfile.TemporaryDirectory() as td:
        archive = MarketMindArchive(Path(td))
        archive.init_fts()
        archive.index_document("2026-05-11", "analysis", "Fed Rate Decision", "The Federal Reserve decided to raise interest rates by 25 basis points.")
        archive.index_document("2026-05-11", "analysis", "Apple Earnings", "Apple Inc. reported quarterly earnings above expectations.")
