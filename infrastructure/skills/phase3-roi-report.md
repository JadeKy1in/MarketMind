...
|-------|------------|-----------|------------|-------------|-------------|----------|
| Track 1 — ax_tree | 0.17 | 0.17 | 0.05 | 1.03 | ✅ PASS | `ax_tree` |
| Track 2 — js_innertext | 0.01 | 0.02 | 0.01 | 0.79 | ✅ PASS | `js_innertext` |
| Track 3 — screenshot_visual | 0.01 | 0.03 | 0.01 | 0.43 | ✅ PASS | `screenshot_visual` |
| Track 3 — SPA Hydration | 0.02 | 0.01 | 0.01 | 0.24 | ✅ PASS | `screenshot_visual` |

**Summary:** Avg=0.62ms Min=0.24ms Max=1.03ms
...
| Failed | 3 |
| Success Rate | 25.0% |
| Avg Time on Success | 1.03ms |
| Total Time Cost | 1.03ms |
...
| Failed | 0 |
| Success Rate | 100.0% |
| Avg Time on Success | 0.62ms |
| Total Time Cost | 2.49ms |

### Delta Analysis
| Metric | Delta |
|--------|-------|
| Success Rate Improvement | **+75.0%** |
| Additional Latency Overhead | -0.41ms avg |
