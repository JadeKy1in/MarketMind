...
### 历史架构经验归档 (Archived Decisions)

> **管理职责**: The Archivist（档案管理员）— 详见 AGENTS.md 第四章（补充）  
> **用途**: 存放子项目结项时提炼的核心架构经验与避坑指南。按时间倒序排列，最新在最上。  
> **提纯格式**: 每条记录不超过 200 字（中文），使用标准化模板。

<!-- Archivist: 以下为归档条目存放区。结项时，将压缩后的记录追加在此。 -->
